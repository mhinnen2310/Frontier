...
| Production/population | `recipes`, `recipe_*`, `production_*`, `workers`, `work_packages`, `worker_activity_tasks`, `city_population_state`, `population_history`, `population_cycle_history`, `demographic_history`, `migration_*` |
...
| V30–V52 | Security/performance and repair integrity, settlement founding/membership governance, normalized districts, building/infrastructure validation and failure, constrained workers/activity scheduling, Builder Guild gameplay and population resilience |
