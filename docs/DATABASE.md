...
| Production/population | `recipes`, `recipe_*`, `production_*`, `workers`, `work_packages`, `worker_activity_tasks`, `ambient_scenes`, `settlement_ambient_state`, `city_population_state`, `population_history`, `population_cycle_history`, `demographic_history`, `migration_*` |
...
| War/repair | `campaigns`, `campaign_*`, `breach_spends`, `combat_activity`, `damage_journal`, `repair_*`, `builder_depots`, `builder_teams`, `builder_team_workers`, `builder_depot_stock`, `builder_guild_contributions`, `builder_guild_history`, `manual_repair_claims`, `material_*`, `territory_transfer_history`, `city_occupations` |
...
| V30–V53 | Security/performance and repair integrity, settlement founding/membership governance, normalized districts, building/infrastructure validation and failure, constrained workers/activity scheduling, Builder Guild gameplay, population resilience and ambient settlement life |
