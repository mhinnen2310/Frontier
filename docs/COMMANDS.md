...
| Settlement | `/frontier city create <name> [\| <charter>]` starts an expedition; `/frontier city expedition status`, `create <name> [\| <charter>]`, `invite <expedition> <player>`, `accept <expedition>`, `found <expedition>`, `cancel <expedition>`; then `info`, `invite <player>`, `invite-revoke <invitation>`, `accept <membership-invitation>`, `members`, `leave`, `kick <player>`, `ban <player> <reason>`, `unban <player>`, `role <player> <role>`, `claim`, `building start <type> [district]`, `building preview\|confirm\|cancel`, `building revalidate <building>`, `building unregister <building> confirm`, `building history <building> [limit]`, `building transfer <building> <target-city>`, `building transfer-accept <proposal>`, `upgrade`, `policy tax <LOW\|STANDARD\|HIGH>`, `transfer <player>`, `succession`, `abandon`, `disband request`, `disband confirm <request>`, `recover`, `merge <city>`, `merge-accept <proposal>`, `history` |
