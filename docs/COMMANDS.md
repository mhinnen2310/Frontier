...
| Settlement | `/frontier city create <name> [\| <charter>]` starts an expedition; `/frontier city expedition status`, `create <name> [\| <charter>]`, `invite <expedition> <player>`, `accept <expedition>`, `found <expedition>`, `cancel <expedition>`; then `info`, `invite <player>`, `accept <membership-invitation>`, `role <player> <role>`, `claim`, `building <type> [radius] [district]`, `upgrade`, `policy tax <LOW\|STANDARD\|HIGH>`, `transfer <player>`, `succession`, `abandon`, `disband`, `recover`, `merge <city>`, `merge-accept <proposal>`, `history` |
